...
function selectNewFilterOption(){
    ...
    selectFilterOption_filterInput(selectedOption);
...
function newFilter_addFeature(){
                    ...
                    if (prevExpression.length==0 || prevExpression.charAt(prevExpression.length-1)=="&" || prevExpression.charAt(prevExpression.length-1)=="|" || prevExpression.charAt(prevExpression.length-1)=="{"){
...
//                if(tmpCnt==0){console.log("fe: " + fe + " fe1: " + fe1 + " fe2: " + fe2);}
                if(tmp==true){
                    fe = fe1 + "true()" + fe2;
                } else {
                    fe = fe1 + "false()" + fe2;
...
//            if(tmpCnt===0){console.log("final eval: "+fe);tmpCnt++;}
            break;
        }
    }
    return output;
...
//                    inOrbit(SSO-600-SSO-PM;CNES_KaRIN)
    ...
    } else if(filterType === "present" || filterType === "absent" || 
